...
/**
 * TABLE NAMES  (as configured in each PA flow's Excel connector dropdowns)
 * These are reference values — the actual table names are set inside PA, not here.
 */
export const TABLE_NAMES = {
  BD_TRACKER:       "BDTrackerTable",
  OPS_CHECKLIST:    "OpsChecklistTable",
  ENGAGEMENT:       "EngagementMasterTable",
  CONTENT_DEV:      "Table 1",          // Content_Development_Tracker.xlsx → Table 1
  SOLUTION_TRACKER: "Table 1",          // Solutioning_Tracker.xlsx → Table 1
};
