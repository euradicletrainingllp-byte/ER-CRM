...
// Preserves the prefix and zero-padding of the last matching ID.
                                ...
                                <>
                                  ...
                                  {solItems.length > 0 ? (
                                    <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12, marginBottom: 8 }}>
                                      <thead>
                                        <tr>
                                          {['Sol S No', 'Solution Topic', 'Line of Service', 'Type of Service', 'Dev Category', 'Sol Value', 'Status', 'Sol To ER', 'Actions'].map(h => (
