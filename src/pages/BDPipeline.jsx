...
import { getBDTracker, addBDRow, updateBDRow, deleteBDRow } from '../services/api.js';
...
export default function BDPipeline({ onRefreshed }) {
  ...
  const handleDelete = async () => {
    ...
    setSaving(true);
    try {
      await deleteBDRow(deleteRow.sno);
      setDeleteRow(null);
      showToast('Lead deleted! S.No auto-updates via Excel formula.');
      await load();
